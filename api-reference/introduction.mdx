...
- Gerenciar usuários e contratos
...
A maioria dos endpoints da API requer autenticação via JWT (JSON Web Token). Apenas os endpoints de **Health Check** e **Criação de Usuário** não requerem autenticação.
...
A API está organizada em cinco grupos principais:
...
<AccordionGroup>
  ...
  <Accordion title="Users">
    Gestão completa de usuários (criação, atualização, exclusão)
  </Accordion>
